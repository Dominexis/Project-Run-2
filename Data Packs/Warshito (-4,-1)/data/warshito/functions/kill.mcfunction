...
execute as @a[tag=Blue,tag=pr.target] at @s if block ~ ~ ~ weeping_vines_plant run function pr:player/checkpoint/send_to
execute as @a[tag=Green,tag=pr.target] at @s if block ~ ~ ~ weeping_vines_plant run function pr:player/checkpoint/send_to
execute as @a[tag=Blue,tag=pr.target] at @s if block ~ ~ ~ vine run function pr:player/checkpoint/send_to
execute as @a[tag=Red,tag=pr.target] at @s if block ~ ~ ~ vine run function pr:player/checkpoint/send_to