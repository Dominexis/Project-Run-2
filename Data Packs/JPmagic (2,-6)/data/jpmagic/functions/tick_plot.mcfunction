...
#RNG HAPPEN
execute as @a[tag=pr.target,tag=!JP_RNG] at @s if block ~ ~ ~ polished_blackstone_pressure_plate run loot spawn ~-31 ~-60 ~34 loot jpmagic:jump_rng
execute positioned ~-31 ~-60 ~34 as @e[type=item,tag=pr.target,distance=..2] as @a[tag=pr.target,tag=!JP_RNG] at @s if block ~ ~ ~ polished_blackstone_pressure_plate run scoreboard players add @s jpmagic.tmp 1
...
#Key Detection
execute at @e[tag=pr.target,tag=jp_key_back] run tp @a[tag=pr.target,distance=..5,predicate=jpmagic:holding_tripwire_hook] ~1 ~ ~-3
...
execute positioned ~-6 ~-70 ~-2 as @a[tag=pr.target,distance=..2] at @s if block ~ ~-1 ~ minecraft:slime_block run effect give @s minecraft:levitation 1 127 true
execute positioned ~-6 ~-70 ~-2 as @a[tag=pr.target,distance=..2] at @s if block ~ ~-1 ~ minecraft:slime_block run clear @s
