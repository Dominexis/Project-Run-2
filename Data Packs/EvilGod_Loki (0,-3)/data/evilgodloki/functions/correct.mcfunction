...
execute if score goal lokicode matches 1 at @e[tag=lokig2] run setblock ~ ~ ~ redstone_block
execute if score goal lokicode matches 2 at @e[tag=lokig4] run setblock ~ ~ ~ redstone_block
...
execute if score goal lokicode matches 2 run playsound block.beacon.activate block @a ~ ~ ~ 1 1 1
execute if score goal lokicode matches 2 run tellraw @a {"text":"Door is open!","bold":true,"color":"dark_purple"}
