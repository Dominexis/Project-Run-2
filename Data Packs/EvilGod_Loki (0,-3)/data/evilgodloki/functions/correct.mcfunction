...
execute if entity @s[tag=lokiused] run title @a[tag=lokiclick,tag=pr.target] subtitle {"text":"This code has already been used.","color":"red"}
execute unless entity @s[tag=lokiused] run title @a[tag=lokiclick,tag=pr.target] subtitle {"text":"Correct!","color":"gold"}
...
execute unless entity @s[tag=lokiused] run tellraw @a[tag=pr.target] ["",{"selector":"@a[tag=lokiclick]","bold":true,"color":"gold"},{"text":" enter the correct code!","bold":true,"color":"green"}]

tag @s add lokiused

execute if score goal lokicode matches 1 at @e[tag=lokig1,tag=pr.target] run setblock ~ ~ ~ redstone_block
execute if score goal lokicode matches 2 at @e[tag=lokig2,tag=pr.target] run setblock ~ ~ ~ redstone_block
...
execute if score goal lokicode matches 5 run tellraw @a[tag=pr.target] {"text":"Door is open!","bold":true,"color":"dark_purple"}
