execute as @e[tag=pr.target,tag=rko_ft4,sort=arbitrary] run data merge entity @s {transformation:{scale:[2.0,2.0,7.0]},start_interpolation:-1,interpolation_duration:5}
