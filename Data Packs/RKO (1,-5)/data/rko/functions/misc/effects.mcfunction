...
execute positioned ~20.5 ~107 ~-1.5 unless entity @s[dx=2,dy=0,dz=2] positioned ~ ~1 ~ run effect give @s[dx=2,dy=0,dz=2,scores={rko.checkpoint=4}] minecraft:levitation 1 255 true
execute positioned ~-23.5 ~107 ~-1.5 unless entity @s[dx=2,dy=0,dz=2] positioned ~ ~1 ~ run effect give @s[dx=2,dy=0,dz=2,scores={rko.checkpoint=4}] minecraft:levitation 1 255 true
