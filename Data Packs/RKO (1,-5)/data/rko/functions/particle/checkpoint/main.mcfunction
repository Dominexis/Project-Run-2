# Right #
execute positioned ~18.5 ~29 ~33.5 run tag @a[tag=pr.target,sort=arbitrary,distance=..20,scores={rko.checkpoint=0}] add rko_cp_particle
...
execute positioned ~18.5 ~29 ~33.5 run tag @a[tag=pr.target,sort=arbitrary,distance=..20,scores={rko.checkpoint=1}] add rko_cp_particle
...
execute positioned ~17.5 ~29 ~-32 run tag @a[tag=pr.target,sort=arbitrary,distance=..20,scores={rko.checkpoint=0..1}] add rko_cp_particle
...
execute positioned ~17.5 ~29 ~-32 run tag @a[tag=pr.target,sort=arbitrary,distance=..20,scores={rko.checkpoint=2}] add rko_cp_particle
...
execute positioned ~30.5 ~41 ~19.5 run tag @a[tag=pr.target,sort=arbitrary,distance=..20,scores={rko.checkpoint=2}] add rko_cp_particle
...
execute positioned ~30.5 ~41 ~19.5 run tag @a[tag=pr.target,sort=arbitrary,distance=..20,scores={rko.checkpoint=3}] add rko_cp_particle
...
execute positioned ~22 ~108 ~5 run tag @a[tag=pr.target,sort=arbitrary,distance=..20,scores={rko.checkpoint=3}] add rko_cp_particle
...
execute positioned ~22 ~108 ~5 run tag @a[tag=pr.target,sort=arbitrary,distance=..20,scores={rko.checkpoint=4}] add rko_cp_particle
...
# Left #
execute positioned ~-20.5 ~29 ~33.5 run tag @a[tag=pr.target,sort=arbitrary,distance=..20,scores={rko.checkpoint=0}] add rko_cp_particle
...
execute positioned ~-20.5 ~29 ~33.5 run tag @a[tag=pr.target,sort=arbitrary,distance=..20,scores={rko.checkpoint=1}] add rko_cp_particle
...
execute positioned ~-18.5 ~29 ~-32 run tag @a[tag=pr.target,sort=arbitrary,distance=..20,scores={rko.checkpoint=0..1}] add rko_cp_particle
...
execute positioned ~-18.5 ~29 ~-32 run tag @a[tag=pr.target,sort=arbitrary,distance=..20,scores={rko.checkpoint=2}] add rko_cp_particle
...
execute positioned ~-31.5 ~41 ~19.5 run tag @a[tag=pr.target,sort=arbitrary,distance=..20,scores={rko.checkpoint=2}] add rko_cp_particle
...
execute positioned ~-31.5 ~41 ~19.5 run tag @a[tag=pr.target,sort=arbitrary,distance=..20,scores={rko.checkpoint=3}] add rko_cp_particle
