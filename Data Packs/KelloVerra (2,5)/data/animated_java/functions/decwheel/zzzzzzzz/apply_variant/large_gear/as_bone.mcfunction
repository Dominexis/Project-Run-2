execute if entity @s[tag=aj.decwheel.bone.thrown_large_cog] run data modify entity @s item.tag.CustomModelData set value 26
execute if entity @s[tag=aj.decwheel.bone.thrown_small_cog] run data modify entity @s item.tag.CustomModelData set value 27
