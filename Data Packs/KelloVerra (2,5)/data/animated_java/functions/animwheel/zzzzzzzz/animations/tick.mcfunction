execute if entity @s[tag=aj.animwheel.animation.minor_cw] run function animated_java:animwheel/zzzzzzzz/animations/minor_cw/tick
execute if entity @s[tag=aj.animwheel.animation.minor_ccw] run function animated_java:animwheel/zzzzzzzz/animations/minor_ccw/tick
