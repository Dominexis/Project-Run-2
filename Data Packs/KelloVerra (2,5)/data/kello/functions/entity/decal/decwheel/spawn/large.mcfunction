...
function animated_java:decwheel/summon/large_gear
...
execute as @e[type=item_display,distance=..0.5,tag=aj.decwheel.root,tag=!kello.decal] run function kello:entity/decal/decwheel/spawn/large_score