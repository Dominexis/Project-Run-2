...
execute unless score @s kello.entity.state = @s kello.entity.state run function kello:entity/decal/parkour_controller/state/idle/start
...
execute if score @s kello.entity.state matches 00 run function kello:entity/decal/parkour_controller/state/idle/state
execute if score @s kello.entity.state matches 01 run function kello:entity/decal/parkour_controller/state/out/state
