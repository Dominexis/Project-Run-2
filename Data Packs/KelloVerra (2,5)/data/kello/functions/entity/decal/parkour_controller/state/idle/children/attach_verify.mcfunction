...
execute if entity @s[tag=kello.entity.type.large] unless entity @e[type=item_display,tag=pr.target,tag=!kello.ignore,tag=kello.entity.type.thrown_cogwheel,tag=kello.entity.type.large,distance=..24] run function kello:entity/thrown/large_cog/state/fixed/as_detach
execute if entity @s[tag=kello.entity.type.small] unless entity @e[type=item_display,tag=pr.target,tag=!kello.ignore,tag=kello.entity.type.thrown_cogwheel,tag=kello.entity.type.small,distance=..24] run function kello:entity/thrown/small_cog/state/fixed/as_detach
