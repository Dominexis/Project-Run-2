...
execute if entity @s[tag=kello.entity.type.large] unless entity @e[type=minecraft:item_display,distance=..24,tag=pr.target,tag=!pr.ignore,tag=kello.entity.type.thrown_cogwheel,tag=kello.entity.type.large] run function kello:entity/thrown/large_cog/state/fixed/as_detach
execute if entity @s[tag=kello.entity.type.small] unless entity @e[type=minecraft:item_display,distance=..24,tag=pr.target,tag=!pr.ignore,tag=kello.entity.type.thrown_cogwheel,tag=kello.entity.type.small] run function kello:entity/thrown/small_cog/state/fixed/as_detach
