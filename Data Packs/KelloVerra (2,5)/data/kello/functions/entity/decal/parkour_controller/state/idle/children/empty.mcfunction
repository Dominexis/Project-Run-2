...
execute if score @s kello.entity.timer matches ..16 as @e[type=item_display,tag=pr.target,tag=!pr.ignore,tag=kello.entity.type.groundicator,distance=...5,sort=nearest,limit=1] run tag @s add kello.dead
