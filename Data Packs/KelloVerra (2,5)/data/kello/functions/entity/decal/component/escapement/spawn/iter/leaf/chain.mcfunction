...
data merge entity @s {Tags:["kello.entity","kello.decal","kello.entity.type.escapement","kello.entity.part.chain","kello.decal.component","kello.decal.controlled","kello.exclude"],item:{id:"minecraft:magenta_stained_glass_pane",tag:{CustomModelData:351907},Count:1b}}
