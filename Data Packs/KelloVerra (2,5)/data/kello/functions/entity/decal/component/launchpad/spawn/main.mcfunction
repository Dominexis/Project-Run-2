...
execute as @e[type=minecraft:item_display,distance=..0.5,tag=aj.launchpad.root,tag=kello.entity.target.new] at @s run function kello:entity/decal/component/launchpad/spawn/as
return 1