...
execute as @e[type=item_display,tag=pr.target,tag=!kello.ignore,tag=kello.entity.type.chain_platform,tag=kello.entity.part.chain,tag=kello.entity.chain_process] at @s run function kello:entity/decal/component/chain_platform/spawn/chain_process
