...
#execute as @e[type=item_display,tag=pr.target,tag=!kello.ignore,tag=kello.entity.type.escapement,tag=kello.entity.part.chain,tag=kello.entity.chain_process] at @s run function kello:entity/decal/component/escapement/spawn/chain_process
