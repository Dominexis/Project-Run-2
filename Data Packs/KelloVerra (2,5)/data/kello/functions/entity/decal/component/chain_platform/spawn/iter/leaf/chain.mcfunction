...
data merge entity @s {Tags:[ "kello.entity","kello.decal","kello.entity.type.chain_platform","kello.entity.part.chain","kello.decal.component","kello.decal.controlled","kello.exclude" ],item:{id:"minecraft:magenta_stained_glass_pane",Count:1b,tag:{CustomModelData:351907}}}
...
function kello:entity/decal/component/chain_platform/spawn/iter/leaf/chain_score
