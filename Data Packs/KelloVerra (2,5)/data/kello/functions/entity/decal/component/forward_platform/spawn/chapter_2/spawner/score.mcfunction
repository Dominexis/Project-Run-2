...
data merge entity @s {view_range:1.75f,billboard:"vertical",Tags:["kello.entity","kello.decal","kello.decal.controlled","kello.decal.component","kello.entity.type.forward_platform_spawner","kello.entity.type.chapter_2"],item:{id:"minecraft:leather_helmet",tag:{CustomModelData:2,display:{color:2106383}},Count:1b},transformation:{scale:[2.75f,1.0f,2.75f]}}
