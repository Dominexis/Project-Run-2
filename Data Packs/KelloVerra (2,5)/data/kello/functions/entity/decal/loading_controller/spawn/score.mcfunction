...
#DEBUG MARKED
#data merge entity @s {transformation:{scale:[1f,1f,1f]},brightness:{block:15,sky:15},billboard:"center",view_range:15,item:{id:"minecraft:magenta_stained_glass_pane",Count:1b,tag:{CustomModelData:351984}},Tags:["kello.entity","kello.decal","kello.entity.type.decal_loading_controller","kello.entity.type.decal_controller","kello.entity.part.main",      "kello.decal.controlled","kello.entity.ticking","kello.entity.target.spawn"]}

data merge entity @s {view_range:0,item:{id:"minecraft:magenta_stained_glass_pane",Count:1b,tag:{CustomModelData:351983}},Tags:["kello.entity","kello.decal","kello.entity.type.decal_loading_controller","kello.entity.type.decal_controller","kello.entity.part.main",      "kello.decal.controlled","kello.entity.ticking","kello.entity.target.spawn"]}
