...
# summon marker ~ ~ ~ {Tags:[ "kello.entity","kello.decal","kello.entity.type.decal_loading_controller","kello.entity.type.decal_controller","kello.entity.part.main",      "kello.decal.controlled","kello.entity.ticking","kello.entity.target.spawn" ]}
execute align xyz positioned ~.5 ~.75 ~.5 summon minecraft:item_display run function kello:entity/decal/loading_controller/spawn/score
