...
execute as @a if score @s kello.player.id = #local kello.player.id run function kello:entity/decal/optional_contraption_controller/state/run/children/cooldown_revert/state