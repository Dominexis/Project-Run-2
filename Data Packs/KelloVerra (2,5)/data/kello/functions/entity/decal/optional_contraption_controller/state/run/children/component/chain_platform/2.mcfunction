...
execute if entity @s[tag=kello.entity.part.platform_visual] run function kello:entity/decal/optional_contraption_controller/state/run/children/component/chain_platform/2_vis
...
execute if entity @s[tag=kello.entity.platform] summon marker run function kello:entity/decal/optional_contraption_controller/state/run/children/component/chain_platform/2_loc