...
execute if entity @s[tag=kello.decal.component] run function kello:entity/decal/optional_contraption_controller/state/run/children/component/verify
...
execute if entity @s[tag=kello.entity.type.soundsource] run function kello:entity/decal/optional_contraption_controller/state/run/children/sfx/sequence
