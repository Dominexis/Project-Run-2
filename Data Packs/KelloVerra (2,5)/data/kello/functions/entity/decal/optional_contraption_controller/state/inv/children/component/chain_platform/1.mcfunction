...
execute if entity @s[tag=kello.entity.part.platform_visual] run function kello:entity/decal/optional_contraption_controller/state/inv/children/component/chain_platform/1_vis
...
execute if entity @s[tag=kello.entity.platform] summon marker run function kello:entity/decal/optional_contraption_controller/state/inv/children/component/chain_platform/1_loc