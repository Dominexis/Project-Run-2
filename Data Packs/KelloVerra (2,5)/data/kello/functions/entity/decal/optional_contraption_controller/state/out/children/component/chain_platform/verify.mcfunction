...
execute if entity @s[tag=kello.entity.platform] run function kello:entity/decal/optional_contraption_controller/state/out/children/component/chain_platform/platform