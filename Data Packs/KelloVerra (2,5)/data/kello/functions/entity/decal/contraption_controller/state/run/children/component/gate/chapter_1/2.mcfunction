...
execute rotated as @s run fill ^1 ^ ^ ^-1 ^7 ^ minecraft:structure_void replace minecraft:spruce_wood
...
# execute if entity @s[tag=kello.entity.part.platform_visual] run function kello:entity/decal/contraption_controller/state/run/children/component/chain_platform/2_vis
