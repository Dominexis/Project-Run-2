...
execute if entity @s[tag=kello.entity.platform] run function kello:entity/decal/contraption_controller/state_optional/out/children/component/chain_platform/platform