...
execute if score @s kello.entity.timer matches 1.. on passengers if entity @s[type=snowball,tag=kello.decal.pointer_origin] on origin rotated as @s positioned as @s run function kello:entity/decal/contraption_controller/state/run/children/main
