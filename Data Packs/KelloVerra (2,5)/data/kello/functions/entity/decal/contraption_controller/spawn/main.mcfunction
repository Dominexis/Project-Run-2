...
# summon marker ~ ~ ~ {Tags:[ "kello.entity","kello.decal","kello.entity.type.decal_contraption_controller","kello.entity.type.decal_controller","kello.entity.part.main",      "kello.decal.controlled","kello.entity.ticking","kello.entity.target.spawn" ]}
execute align xyz positioned ~.5 ~.75 ~.5 summon minecraft:item_display run function kello:entity/decal/contraption_controller/spawn/score
