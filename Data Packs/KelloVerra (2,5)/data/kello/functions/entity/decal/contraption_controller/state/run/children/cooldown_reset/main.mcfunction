execute if entity @s[tag=kello.entity.type.small] run function kello:entity/decal/contraption_controller/state/run/children/cooldown_reset/small
execute if entity @s[tag=kello.entity.type.large] run function kello:entity/decal/contraption_controller/state/run/children/cooldown_reset/large
