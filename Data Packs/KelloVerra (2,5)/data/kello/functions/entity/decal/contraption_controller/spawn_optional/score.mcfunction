...
data merge entity @s {view_range:0,item:{id:"minecraft:magenta_stained_glass_pane",tag:{CustomModelData:351983},Count:1b},Tags:["kello.entity","kello.decal","kello.entity.type.decal_contraption_controller","kello.entity.type.decal_controller","kello.entity.part.main","kello.entity.type.optional","kello.decal.controlled","kello.entity.ticking"]}
