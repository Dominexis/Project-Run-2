...
data merge entity @s {view_range:0,item:{id:"minecraft:magenta_stained_glass_pane",Count:1b,tag:{CustomModelData:351983}},Tags:["kello.entity","kello.decal","kello.entity.type.decal_contraption_controller","kello.entity.type.decal_controller","kello.entity.part.main","kello.entity.type.optional",      "kello.decal.controlled","kello.entity.ticking"]}
