...
data merge entity @s {transformation:{scale:[1.05f,1f,1.05f]},brightness:{block:12,sky:12},view_range:15,Tags:["kello.entity","kello.entity.type.groundicator","kello.entity.part.indicator","kello.entity.type.large","kello.entity.ticking"]}
