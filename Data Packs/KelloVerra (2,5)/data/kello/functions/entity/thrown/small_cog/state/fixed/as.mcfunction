...
execute as @e[type=item_display,tag=pr.target,tag=!pr.ignore,tag=kello.entity.type.groundicator,tag=kello.entity.type.small,distance=...1,sort=nearest] run tag @s add kello.dead
