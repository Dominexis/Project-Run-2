...
#execute positioned ^ ^ ^-1 if entity @e[type=item_display,tag=pr.target,tag=!pr.ignore,tag=kello.decal,tag=kello.empty,tag=kello.entity.type.cogwheel_shaft,tag=kello.entity.type.small,distance=..2] run function kello:entity/thrown/small_cog/state/fixed/start
#execute positioned ^ ^ ^2.5 if entity @e[type=item_display,tag=pr.target,tag=!pr.ignore,tag=kello.decal,tag=kello.empty,tag=kello.entity.type.cogwheel_shaft,tag=kello.entity.type.small,distance=..1.5] run function kello:entity/thrown/small_cog/state/fixed/start