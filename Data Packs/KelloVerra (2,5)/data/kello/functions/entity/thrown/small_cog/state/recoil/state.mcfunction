...
execute positioned ~ ~-1 ~ if entity @e[type=marker,tag=kello.entity.target,tag=kello.entity.aim,distance=..3.75] positioned ~ ~1 ~ run function kello:entity/thrown/small_cog/state/pickup/start
