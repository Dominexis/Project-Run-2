...
execute unless score #state kello.value matches 1..4 if block ~ ~ ~ structure_void run function kello:entity/thrown/small_cog/state/recoil/fail_n_fixed_check
execute unless score #state kello.value matches 1..4 positioned ^ ^ ^-0.5 if block ~ ~ ~ structure_void run function kello:entity/thrown/small_cog/state/recoil/fail_n_fixed_check
execute unless score #state kello.value matches 1..4 positioned ^ ^ ^0.5 if block ~ ~ ~ structure_void run function kello:entity/thrown/small_cog/state/recoil/fail_n_fixed_check
execute unless score #state kello.value matches 1..4 positioned ^ ^ ^1.0 if block ~ ~ ~ structure_void run function kello:entity/thrown/small_cog/state/recoil/fail_n_fixed_check
execute unless score #state kello.value matches 1..4 positioned ^ ^ ^1.5 if block ~ ~ ~ structure_void run function kello:entity/thrown/small_cog/state/recoil/fail_n_fixed_check