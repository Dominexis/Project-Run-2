...
execute as @e[type=item_display,tag=pr.target,tag=!kello.ignore,tag=kello.entity.type.groundicator,tag=kello.entity.type.large,distance=..1,sort=nearest] run tag @s add kello.dead
