...
execute as @e[type=minecraft:marker,tag=kello.decal.temp_spawn_point,tag=kello.decal.unregistered] run function kello:debug/decal/gen/as
...
execute if score #generator.new_instance kello.value matches 1 run function kello:debug/decal/gen/new_instance
return 1