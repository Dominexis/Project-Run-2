...
tellraw @a ["","execute positioned ~",{"color":"gold","bold":true,"nbt":"tag.decal.notify.data.Pos_local[0]","storage":"kello:data"}," ~",{"color":"gold","bold":true,"nbt":"tag.decal.notify.data.Pos_local[1]","storage":"kello:data"}," ~",{"color":"gold","bold":true,"nbt":"tag.decal.notify.data.Pos_local[2]","storage":"kello:data"}," summon marker run data merge entity @s {Tags:",{"nbt":"tag.decal_identifier","storage":"kello:data"},",data:{variant:",{"score":{"name":"#decal_variant","objective":"kello.value"}},"},","Rotation:[",{"score":{"name":"#rot_0","objective":"kello.value"}},".0f,",{"score":{"name":"#rot_1","objective":"kello.value"}},".0f]}"]