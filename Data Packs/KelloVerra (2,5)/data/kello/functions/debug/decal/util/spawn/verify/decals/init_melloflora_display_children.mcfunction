...
execute if entity @s[tag=aj.cogwheel.bone.large_cog] run data merge entity @s {Tags:["aj.cogwheel.bone","kello.exclude","aj.cogwheel.rig_entity","aj.cogwheel.bone.large_cog","kello.ignore"],billboard:"vertical"}
