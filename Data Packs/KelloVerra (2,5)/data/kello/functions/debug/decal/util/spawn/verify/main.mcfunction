...
execute if score #decal kello.value = $decal.bg_sml_melloflora_lantern kello.decal align xyz positioned ~.5 ~.5 ~.5 run summon minecraft:marker ~ ~ ~ {Tags:["kello.decal.spawn_point","kello.decal.type.melloflora_lantern","pr.ignore","kello.decal.init"],data:{variant:0}}
execute if score #decal kello.value = $decal.bg_med_melloflora_lantern kello.decal align xyz positioned ~.5 ~.5 ~.5 run summon minecraft:marker ~ ~ ~ {Tags:["kello.decal.spawn_point","kello.decal.type.melloflora_lantern","pr.ignore","kello.decal.init"],data:{variant:1}}
execute if score #decal kello.value = $decal.bg_lar_melloflora_lantern kello.decal align xyz positioned ~.5 ~.5 ~.5 run summon minecraft:marker ~ ~ ~ {Tags:["kello.decal.spawn_point","kello.decal.type.melloflora_lantern","pr.ignore","kello.decal.init"],data:{variant:2}}

execute if score #decal kello.value = $decal.bg_sml_wall_mellolily kello.decal align xyz positioned ~.5 ~.5 ~.5 run summon minecraft:marker ~ ~ ~ {Tags:["kello.decal.spawn_point","kello.decal.type.wall_mellolily","pr.ignore","kello.decal.init"],data:{variant:0}}
execute if score #decal kello.value = $decal.bg_med_wall_mellolily kello.decal align xyz positioned ~.5 ~.5 ~.5 run summon minecraft:marker ~ ~ ~ {Tags:["kello.decal.spawn_point","kello.decal.type.wall_mellolily","pr.ignore","kello.decal.init"],data:{variant:1}}
execute if score #decal kello.value = $decal.bg_lar_wall_mellolily kello.decal align xyz positioned ~.5 ~.5 ~.5 run summon minecraft:marker ~ ~ ~ {Tags:["kello.decal.spawn_point","kello.decal.type.wall_mellolily","pr.ignore","kello.decal.init"],data:{variant:2}}
...
execute if score #decal kello.value = $decal.bg_melloleta_patch_singular kello.decal align xyz positioned ~.5 ~ ~.5 run summon minecraft:marker ~ ~ ~ {Tags:["kello.decal.spawn_point","kello.decal.type.melloleta","pr.ignore","kello.decal.init"],data:{variant:0}}
...
execute if score #decal kello.value = $decal.mellobanner_2 kello.decal align xyz positioned ~.5 ~.5 ~.5 run summon minecraft:marker ~ ~ ~ {Tags:["kello.decal.spawn_point","kello.decal.type.mellobanner","pr.ignore","kello.decal.init"],data:{variant:2}}

execute if score #decal kello.value = $decal.animwheel_0 kello.decal align xyz positioned ~.5 ~.5 ~.5 run summon minecraft:marker ~ ~ ~ {Tags:["kello.decal.spawn_point","kello.decal.type.animwheel_dummy","pr.ignore","kello.decal.init"],data:{variant:0}}
execute if score #decal kello.value = $decal.animwheel_1 kello.decal align xyz positioned ~.5 ~.5 ~.5 run summon minecraft:marker ~ ~ ~ {Tags:["kello.decal.spawn_point","kello.decal.type.animwheel_dummy","pr.ignore","kello.decal.init"],data:{variant:1}}
execute if score #decal kello.value = $decal.animwheel_2 kello.decal align xyz positioned ~.5 ~.5 ~.5 run summon minecraft:marker ~ ~ ~ {Tags:["kello.decal.spawn_point","kello.decal.type.animwheel_dummy","pr.ignore","kello.decal.init"],data:{variant:2}}
execute if score #decal kello.value = $decal.animwheel_3 kello.decal align xyz positioned ~.5 ~.5 ~.5 run summon minecraft:marker ~ ~ ~ {Tags:["kello.decal.spawn_point","kello.decal.type.animwheel_dummy","pr.ignore","kello.decal.init"],data:{variant:3}}
execute if score #decal kello.value = $decal.animwheel_4 kello.decal align xyz positioned ~.5 ~.5 ~.5 run summon minecraft:marker ~ ~ ~ {Tags:["kello.decal.spawn_point","kello.decal.type.animwheel_dummy","pr.ignore","kello.decal.init"],data:{variant:4}}
execute if score #decal kello.value = $decal.animwheel_5 kello.decal align xyz positioned ~.5 ~.5 ~.5 run summon minecraft:marker ~ ~ ~ {Tags:["kello.decal.spawn_point","kello.decal.type.animwheel_dummy","pr.ignore","kello.decal.init"],data:{variant:5}}
execute if score #decal kello.value = $decal.animwheel_6 kello.decal align xyz positioned ~.5 ~.5 ~.5 run summon minecraft:marker ~ ~ ~ {Tags:["kello.decal.spawn_point","kello.decal.type.animwheel_dummy","pr.ignore","kello.decal.init"],data:{variant:6}}
execute if score #decal kello.value = $decal.animwheel_7 kello.decal align xyz positioned ~.5 ~.5 ~.5 run summon minecraft:marker ~ ~ ~ {Tags:["kello.decal.spawn_point","kello.decal.type.animwheel_dummy","pr.ignore","kello.decal.init"],data:{variant:7}}
execute if score #decal kello.value = $decal.animwheel_8 kello.decal align xyz positioned ~.5 ~.5 ~.5 run summon minecraft:marker ~ ~ ~ {Tags:["kello.decal.spawn_point","kello.decal.type.animwheel_dummy","pr.ignore","kello.decal.init"],data:{variant:8}}

scoreboard players set #kill kello.value 1
execute as @e[type=minecraft:marker,distance=..4,tag=kello.decal.spawn_point,tag=kello.decal.init] positioned as @s run function kello:debug/decal/util/spawn/verify/decals/process_decals
