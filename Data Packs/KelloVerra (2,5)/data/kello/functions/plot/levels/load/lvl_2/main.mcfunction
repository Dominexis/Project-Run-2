...
execute positioned ~-2 ~11 ~-3 align xyz positioned ~.5 ~.5 ~.5 summon marker run data merge entity @s {Tags:["kello.entity.type.small_decwheel_gear","kello.state.0","kello.rot_mode.1","kello.decal.temp_spawn_point"],Rotation:[180.0f,0.0f]}
execute positioned ~-1 ~11 ~-3 align xyz positioned ~.5 ~.5 ~.5 summon marker run data merge entity @s {Tags:["kello.entity.type.small_decwheel_gear","kello.state.0","kello.rot_mode.0","kello.decal.temp_spawn_point"],Rotation:[180.0f,0.0f]}
execute positioned ~0 ~12 ~-3 align xyz positioned ~.5 ~.5 ~.5 summon marker run data merge entity @s {Tags:["kello.entity.type.large_cogwheel_shaft","kello.state.1","kello.rot_mode.1","kello.decal.temp_spawn_point"],Rotation:[180.0f,0.0f]}
execute positioned ~1 ~13 ~-3 align xyz positioned ~.5 ~.5 ~.5 summon marker run data merge entity @s {Tags:["kello.entity.type.small_decwheel_gear","kello.state.2","kello.rot_mode.0","kello.decal.temp_spawn_point"],Rotation:[180.0f,0.0f]}
execute positioned ~-2 ~2 ~-10 align xyz positioned ~.5 ~.5 ~.5 summon marker run data merge entity @s {Tags:["kello.entity.type.moving_platform","kello.decal.temp_spawn_point"],Rotation:[180.0f,0.0f]}
execute positioned ~1 ~3 ~6 align xyz positioned ~.5 ~.5 ~.5 summon marker run data merge entity @s {Tags:["kello.entity.type.moving_platform","kello.decal.temp_spawn_point"],Rotation:[0.0f,0.0f]}
execute positioned ~0 ~3 ~11 align xyz positioned ~.5 ~.5 ~.5 summon marker run data merge entity @s {Tags:["kello.entity.type.large_decwheel_gear","kello.rot_mode.-1","kello.decal.temp_spawn_point"],Rotation:[0.0f,-90.0f]}
execute positioned ~0 ~3 ~11 align xyz positioned ~.5 ~.5 ~.5 summon marker run data merge entity @s {Tags:["kello.entity.type.large_groundicator","kello.decal.temp_spawn_point"],Rotation:[0.0f,0.0f]}
