...
execute if score #load_level_id kello.value matches 3 if score #level_variant_to_load kello.value matches 1 run function kello:plot/levels/load/lvl_3/section_b
