data merge entity @s {Silent:1b,NoAI:1b,Invulnerable:1b,Tags:["pr.target","kello.entity","kello.entity.type.chariot","kello.entity.type.squishy","kello.entity.ticking"],active_effects:[{id:"minecraft:invisibility",amplifier:1b,duration:200000,show_particles:0b}]}
