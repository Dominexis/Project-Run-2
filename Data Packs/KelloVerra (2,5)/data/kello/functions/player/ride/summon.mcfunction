...
execute if score #boolean kello.value matches 1 on vehicle if entity @s[type=minecraft:pufferfish,tag=kello.entity.type.chariot] on passengers run function kello:player/ride/unride



# Ride initialization

execute if score #ridelock kello.value matches 0 positioned ~ ~.25 ~ summon minecraft:pufferfish run function kello:player/ride/score
execute if score #ridelock kello.value matches 1 positioned ~ ~.25 ~ summon minecraft:pufferfish run function kello:player/ride/score_new_lock
