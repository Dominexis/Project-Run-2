data merge entity @s {Silent:1b,NoAI:1b,Invulnerable:1b,ActiveEffects:[{Id:14,Amplifier:1b,Duration:200000,ShowParticles:0b}],Tags:["pr.target","kello.entity","kello.entity.type.chariot","kello.entity.lock","kello.entity.type.squishy","kello.entity.ticking"]}
