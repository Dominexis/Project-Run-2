...
execute if score @s kello.player.cog.l matches 3 as @e[type=minecraft:item_display,tag=pr.target,tag=!pr.ignore,tag=!kello.exclude,tag=kello.entity.type.thrown_cogwheel,tag=kello.entity.type.large] if score @s kello.player.id = #local kello.player.id positioned as @s run function kello:entity/thrown/large_cog/generic/unstuck_verify
execute if score @s kello.player.cog.r matches 3 as @e[type=minecraft:item_display,tag=pr.target,tag=!pr.ignore,tag=!kello.exclude,tag=kello.entity.type.thrown_cogwheel,tag=kello.entity.type.small] if score @s kello.player.id = #local kello.player.id positioned as @s run function kello:entity/thrown/small_cog/generic/unstuck_verify
return 1