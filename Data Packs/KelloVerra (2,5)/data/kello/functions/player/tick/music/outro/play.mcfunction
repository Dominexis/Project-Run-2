...
scoreboard players operation @s kello.player.music_timestamp += #music_outro_duration kello.player.music_timestamp

scoreboard players set @s kello.player.music_progress 3
...
playsound kello:music_outro music @s ~ ~ ~ 0.6125 1 0.6125