...
execute if score @s kello.player.music_timestamp < #time pr.value if entity @s[tag=!kello.music_queue,tag=kello.music_repeat] run function kello:player/tick/music/final/play
