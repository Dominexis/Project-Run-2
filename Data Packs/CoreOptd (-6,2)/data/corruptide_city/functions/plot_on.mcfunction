...
#START TEXT
summon text_display ~32 ~2 ~0 {Tags:["corecity.kill_entities"],billboard:"fixed",see_through:0b,Rotation:[-90F,0F],text:'[{"text":"X","color":"light_purple","bold":true,"obfuscated":true},{"text":"Corruptide City","color":"dark_purple","bold":true,"obfuscated":false},{"text":"X","color":"light_purple","bold":true,"obfuscated":true},{"text":"\\nby ","color":"yellow","bold":true,"obfuscated":false},{"text":"CoreOptd","color":"gold","bold":true,"obfuscated":false}]',background:16711680}
