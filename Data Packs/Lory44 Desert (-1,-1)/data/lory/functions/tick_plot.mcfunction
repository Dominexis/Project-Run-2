...
execute align xyz positioned ~-40 ~-1.75 ~-40 as @a[dx=80,dy=0,dz=80,tag=pr.target,predicate=!lory:on_raft] run function lory:drowning

execute align xyz positioned ~28 ~3 ~32 as @a[dx=2,dy=11,dz=0,tag=pr.target] run function lory:drowning
