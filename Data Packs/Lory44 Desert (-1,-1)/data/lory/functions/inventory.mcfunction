...
execute if entity @s[tag=lory.oasis,tag=lory.has_raft,scores={lory.drop_raft=1..}] run kill @e[type=minecraft:item,distance=..6,nbt={Item:{id:"minecraft:bamboo_raft"}},limit=1]
