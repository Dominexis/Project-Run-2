...
tellraw @a[tag=pr.target,tag=lory.has_raft,scores={lory.var=1..}] ["",{"text":"You found the raft of the ","color":"gray","type":"text"},{"text":"Raft Keeper","color":"light_purple","type":"text"},{"text":", go back & give it to him!","color":"gray","type":"text"}]
