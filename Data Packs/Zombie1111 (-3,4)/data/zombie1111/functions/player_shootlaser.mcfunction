...
scoreboard players operation @e[type=armor_stand,tag=zombieNew,tag=pr.target,limit=1] zombie_idplayer = @s zombie_idplayer
execute as @e[type=armor_stand,tag=zombieNew,tag=pr.target,limit=1] run function zombie1111:player_shootlaser_configure
