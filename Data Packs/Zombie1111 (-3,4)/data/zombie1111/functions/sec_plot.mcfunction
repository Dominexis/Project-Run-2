...
execute as @a[tag=zombiePlotPlayer] at @s run function zombie1111:player_sec
...
execute as @e[type=#zombie1111:spawnable,tag=zombiePlot] at @s if block ~ ~-0.9 ~ #zombie1111:deathblocks run kill @s
