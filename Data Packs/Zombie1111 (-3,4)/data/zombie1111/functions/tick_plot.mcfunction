...
execute as @e[type=marker,tag=zombieDeathPos,tag=pr.target] unless predicate zombie1111:ismobdied at @s run function zombie1111:mob_death_pos
execute as @e[type=armor_stand,tag=zombieBullet,tag=pr.target] at @s run function zombie1111:laser_tick
