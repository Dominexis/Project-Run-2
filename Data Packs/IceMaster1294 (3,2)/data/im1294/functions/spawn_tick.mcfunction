...
# Now summon more!
execute if score im1294.Zombies im1294.wall_right matches ..3 run summon zombie ~-18 ~40 ~ {Tags:["pr.target","im1294.wall_right"],ActiveEffects:[{Id:12,ShowParticles:0b,Duration:9999}],ArmorItems:[{},{},{},{id:"stone_button",Count:1}]}
...
execute if score im1294.Zombies im1294.entrance_right matches ..2 run summon zombie ~-28 ~23 ~-28 {Tags:["pr.target","im1294.entrance_right"],ActiveEffects:[{Id:12,ShowParticles:0b,Duration:9999}],ArmorItems:[{},{},{},{id:"stone_button",Count:1}],HandItems:[{id:"bow",Count:1}],HandDropChances:[0.00f]}
...
execute if score im1294.Zombies im1294.wall_left matches ..2 run summon zombie ~24 ~39 ~11 {Tags:["pr.target","im1294.wall_left"],ActiveEffects:[{Id:12,ShowParticles:0b,Duration:9999}],ArmorItems:[{},{},{},{id:"stone_button",Count:1}]}
...
execute if score im1294.Zombies im1294.entrance_left matches ..2 run summon zombie ~28 ~25 ~-13 {Tags:["pr.target","im1294.entrance_left"],ActiveEffects:[{Id:12,ShowParticles:0b,Duration:9999}],ArmorItems:[{},{},{},{id:"stone_button",Count:1}]}
execute if score im1294.Skeletons im1294.entrance_left matches ..2 run summon skeleton ~37 ~32 ~-12 {Tags:["pr.target","im1294.entrance_left"],ActiveEffects:[{Id:12,ShowParticles:0b,Duration:9999}],ArmorItems:[{},{},{},{id:"stone_button",Count:1}],HandItems:[{id:"bow",Count:1}],HandDropChances:[0.00f]}
...
execute if score im1294.Zombies im1294.central matches ..2 run summon zombie ~6 ~50 ~19 {Tags:["pr.target","im1294.central"],ActiveEffects:[{Id:12,ShowParticles:0b,Duration:9999}],ArmorItems:[{},{},{},{id:"stone_button",Count:1}]}
execute if score im1294.Skeletons im1294.central matches ..2 run summon skeleton ~-2 ~48 ~23 {Tags:["pr.target","im1294.central"],ActiveEffects:[{Id:12,ShowParticles:0b,Duration:9999}],ArmorItems:[{},{},{},{id:"stone_button",Count:1}],HandItems:[{id:"bow",Count:1}],HandDropChances:[0.00f]}
execute if score im1294.Spiders im1294.central matches ..2 run summon spider ~12 ~47 ~34 {Tags:["pr.target","im1294.central"],ActiveEffects:[{Id:12,ShowParticles:0b,Duration:9999}],ArmorItems:[{},{},{},{id:"stone_button",Count:1}]}
