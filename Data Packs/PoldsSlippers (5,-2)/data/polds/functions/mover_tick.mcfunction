...
execute as @e[tag=polds.flipper1L,tag=pr.target] at @s if block ~ ~-1 ~ spruce_slab run scoreboard players set direction1 polds.system 1
execute as @e[tag=polds.flipper1R,tag=pr.target] at @s if block ~ ~-1 ~ spruce_slab run scoreboard players set direction1 polds.system 0
...
execute as @e[tag=polds.flipper2L,tag=pr.target] at @s if block ~ ~-1 ~ spruce_slab run scoreboard players set direction2 polds.system 1
execute as @e[tag=polds.flipper2R,tag=pr.target] at @s if block ~ ~-1 ~ spruce_slab run scoreboard players set direction2 polds.system 0
...
execute as @e[tag=polds.flipper3L,tag=pr.target] at @s if block ~ ~-1 ~ spruce_slab run scoreboard players set direction3 polds.system 1
execute as @e[tag=polds.flipper3R,tag=pr.target] at @s if block ~ ~-1 ~ spruce_slab run scoreboard players set direction3 polds.system 0
...
execute as @e[tag=polds.flipper4L,tag=pr.target] at @s if block ~ ~-1 ~ polished_blackstone_brick_slab run scoreboard players set direction4 polds.system 1
execute as @e[tag=polds.flipper4R,tag=pr.target] at @s if block ~ ~-1 ~ polished_blackstone_brick_slab run scoreboard players set direction4 polds.system 0
...
execute as @e[tag=polds.flipper5D,tag=pr.target] at @s if block ~ ~-1 ~ polished_blackstone_brick_slab run scoreboard players set direction5 polds.system 1
execute as @e[tag=polds.flipper5U,tag=pr.target] at @s if block ~ ~-1 ~ polished_blackstone_brick_slab run scoreboard players set direction5 polds.system 0

# mover 6
execute as @e[tag=polds.mover6,tag=pr.target] at @s run setblock ~ ~-1 ~ chain[axis=z]
execute unless score direction6 polds.system matches 1 as @e[tag=polds.mover6,tag=pr.target] at @s run setblock ~ ~-1 ~-1 red_nether_bricks
execute unless score direction6 polds.system matches 1 as @e[tag=polds.mover6,tag=pr.target] at @s run tp ~ ~ ~-1
execute if score direction6 polds.system matches 1 as @e[tag=polds.mover6,tag=pr.target] at @s run setblock ~ ~-1 ~1 red_nether_bricks
execute if score direction6 polds.system matches 1 as @e[tag=polds.mover6,tag=pr.target] at @s run tp ~ ~ ~1
execute as @e[tag=polds.flipper6L,tag=pr.target] at @s if block ~ ~-1 ~ red_nether_bricks run scoreboard players set direction6 polds.system 1
execute as @e[tag=polds.flipper6R,tag=pr.target] at @s if block ~ ~-1 ~ red_nether_bricks run scoreboard players set direction6 polds.system 0
...
execute as @e[tag=polds.flipper7L,tag=pr.target] at @s if block ~ ~-1 ~ polished_blackstone_brick_slab run scoreboard players set direction7 polds.system 1
execute as @e[tag=polds.flipper7R,tag=pr.target] at @s if block ~ ~-1 ~ polished_blackstone_brick_slab run scoreboard players set direction7 polds.system 0