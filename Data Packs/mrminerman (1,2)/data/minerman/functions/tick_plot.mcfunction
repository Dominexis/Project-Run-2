...
execute positioned ~-13 ~-37 ~-37 if score $fire painting_parkour matches 19 run playsound minecraft:entity.generic.extinguish_fire master @a[tag=pr.target,dx=9,dy=-20,dz=32] ~ ~ ~ 2
...
execute positioned ~7 ~-7 ~-37 run effect give @a[tag=pr.target,dx=9,dy=-30,dz=75] minecraft:jump_boost 1 3
execute positioned ~7 ~-7 ~-37 run effect give @a[tag=pr.target,dx=9,dy=-30,dz=75] minecraft:slow_falling 1 3
...
#tp's up
execute positioned ~0 ~-51 ~-3 as @a[tag=pr.target,dx=3,dy=-3,dz=0,gamemode=!spectator] at @s run tp @s ~0 ~51 ~-24
execute positioned ~-10 ~-51 ~-3 as @a[tag=pr.target,dx=3,dy=-3,dz=0,gamemode=!spectator] at @s run tp @s ~10 ~51 ~12
execute positioned ~-20 ~-51 ~-3 as @a[tag=pr.target,dx=3,dy=-3,dz=0,gamemode=!spectator] at @s run tp @s ~20 ~51 ~-12
execute positioned ~-30 ~-51 ~-3 as @a[tag=pr.target,dx=3,dy=-3,dz=0,gamemode=!spectator] at @s run tp @s ~27 ~51 ~-24
execute positioned ~10 ~-51 ~34 as @a[tag=pr.target,dx=3,dy=-3,dz=0,gamemode=!spectator] at @s run tp @s ~-13 ~51 ~-49
execute positioned ~0 ~-51 ~34 as @a[tag=pr.target,dx=3,dy=-3,dz=0,gamemode=!spectator] at @s run tp @s ~-3 ~51 ~-25
execute positioned ~-10 ~-51 ~34 as @a[tag=pr.target,dx=3,dy=-3,dz=0,gamemode=!spectator] at @s run tp @s ~10 ~51 ~-13
execute positioned ~-20 ~-51 ~34 as @a[tag=pr.target,dx=3,dy=-3,dz=0,gamemode=!spectator] at @s run tp @s ~20 ~51 ~-37
execute positioned ~-30 ~-51 ~34 as @a[tag=pr.target,dx=3,dy=-3,dz=0,gamemode=!spectator] at @s run tp @s ~27 ~51 ~-13
execute positioned ~10 ~-31 ~37 as @a[tag=pr.target,dx=3,dy=-3,dz=0,gamemode=!spectator] at @s run tp @s ~-13 ~31 ~-40


#tp's down

execute positioned ~-3 ~1 ~-30 as @a[tag=pr.target,dx=3,dy=-3,dz=0,gamemode=!spectator] at @s run tp @s ~-27 ~-46 ~-4
execute positioned ~3 ~1 ~-30 as @a[tag=pr.target,dx=-3,dy=3,dz=0,gamemode=!spectator] at @s run tp @s ~0 ~-46 ~-4
execute positioned ~3 ~1 ~-18 as @a[tag=pr.target,dx=-3,dy=3,dz=0,gamemode=!spectator] at @s run tp @s ~-20 ~-46 ~-16
execute positioned ~-3 ~1 ~-18 as @a[tag=pr.target,dx=3,dy=-3,dz=0,gamemode=!spectator] at @s run tp @s ~13 ~-46 ~21
execute positioned ~3 ~1 ~-6 as @a[tag=pr.target,dx=-3,dy=3,dz=0,gamemode=!spectator] at @s run tp @s ~-20 ~-46 ~9
execute positioned ~-3 ~1 ~-6 as @a[tag=pr.target,dx=3,dy=-3,dz=0,gamemode=!spectator] at @s run tp @s ~13 ~-16 ~-28
execute positioned ~-3 ~1 ~6 as @a[tag=pr.target,dx=-3,dy=3,dz=0,gamemode=!spectator] at @s run tp @s ~-10 ~-46 ~-40
execute positioned ~3 ~1 ~6 as @a[tag=pr.target,dx=3,dy=-3,dz=0,gamemode=!spectator] at @s run tp @s ~3 ~-46 ~-3
execute positioned ~3 ~1 ~18 as @a[tag=pr.target,dx=-3,dy=3,dz=0,gamemode=!spectator] at @s run tp @s ~-10 ~-45 ~-15
execute positioned ~-3 ~1 ~18 as @a[tag=pr.target,dx=3,dy=-3,dz=0,gamemode=!spectator] at @s run tp @s ~-27 ~-46 ~-15
