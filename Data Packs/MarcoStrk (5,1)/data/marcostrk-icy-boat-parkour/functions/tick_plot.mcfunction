...
execute as @a[tag=pr.target] at @s if block ~ -64 ~ red_concrete run function marcostrk-icy-boat-parkour:players/main
...
execute positioned ~-40 0 ~-40 run kill @a[tag=pr.target,dx=80,dy=14,dz=80]
