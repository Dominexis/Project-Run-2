...
execute if entity @s[scores={funkytoc.moon.particle.dust=0}] run particle minecraft:dust_color_transition .9 .9 .9 1.2 1 1 1 ~ ~.02 ~ .2 0 .2 0 10 normal @a[tag=pr.target,distance=..128]
