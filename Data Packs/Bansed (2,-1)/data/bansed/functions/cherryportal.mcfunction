...
execute if score @s bnsd.cherryportal matches 2 run effect give @s nausea 10 1 true
...
execute if score @s bnsd.cherryportal matches 50 run effect clear @s nausea
