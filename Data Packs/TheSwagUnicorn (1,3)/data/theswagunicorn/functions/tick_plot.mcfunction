...
execute if score Conveyor1 TimerForSwag >= 16 TimerForSwag run execute as @e[type=marker,tag=Conveyor1,tag=pr.target] at @s run clone ~2 ~-9 ~-2 ~4 ~-11 ~6 ~ ~ ~
...
execute if score Conveyor1 TimerForSwag >= 16 TimerForSwag run execute as @e[type=marker,tag=Conveyor1,tag=pr.target] at @s run summon creeper ~1 ~3 ~ {NoAI:1b,Silent:1b,Tags:["JeepersCreepers","pr.target"]}
...
execute if score Conveyor2 TimerForSwag >= 16 TimerForSwag run execute as @e[type=marker,tag=Conveyor1,tag=pr.target] at @s run clone ~8 ~-9 ~-2 ~10 ~-11 ~6 ~ ~ ~
...
execute if score Conveyor2 TimerForSwag >= 16 TimerForSwag run execute as @e[type=marker,tag=Conveyor2,tag=pr.target] at @s run summon creeper ~1 ~2 ~8 {NoAI:1b,Silent:1b,Tags:["JeepersCreepers","pr.target"],Rotation:[180f,0f]}
