...
# Red (correct)
execute positioned ~ ~2 ~-26 as @s[scores={eosand.pipe_num=1},distance=..0.25,y_rotation=45..135,x_rotation=-45..45] run scoreboard players set @s eosand.junctions 1
...
# Green
execute positioned ~ ~2 ~-26 as @s[scores={eosand.pipe_num=1},distance=..0.25,y_rotation=-135..-45,x_rotation=-45..45] run scoreboard players set @s eosand.pipe_num -3
...
# Cyan
execute positioned ~ ~2 ~-26 as @s[scores={eosand.pipe_num=1},distance=..0.25,x_rotation=45..90] run scoreboard players set @s eosand.pipe_num -5

# Purple
execute positioned ~ ~2 ~-26 as @s[scores={eosand.pipe_num=1},distance=..0.25,x_rotation=-90..-45] run scoreboard players set @s eosand.pipe_num -6

# Center player in pipe immediately after junction to tp them cleanly
execute as @s[scores={eosand.junctions=1}] on vehicle run tp @s ~-2 ~1 ~-26
...
# Yellow
execute positioned ~-26 ~2 ~-26 as @s[scores={eosand.pipe_num=2},distance=..0.25,y_rotation=135..180,x_rotation=-45..45] run scoreboard players set @s eosand.pipe_num -2
execute positioned ~-26 ~2 ~-26 as @s[scores={eosand.pipe_num=2},distance=..0.25,y_rotation=-180..-135,x_rotation=-45..45] run scoreboard players set @s eosand.pipe_num -2
...
# Pink
execute positioned ~-26 ~2 ~-26 as @s[scores={eosand.pipe_num=2},distance=..0.25,y_rotation=-45..0,x_rotation=-45..45] run scoreboard players set @s eosand.pipe_num -4
execute positioned ~-26 ~2 ~-26 as @s[scores={eosand.pipe_num=2},distance=..0.25,y_rotation=0..45,x_rotation=-45..45] run scoreboard players set @s eosand.pipe_num -4

# Cyan
execute positioned ~-26 ~2 ~-26 as @s[scores={eosand.pipe_num=2},distance=..0.25,x_rotation=45..90] run scoreboard players set @s eosand.pipe_num -5

# Purple (correct)
execute positioned ~-26 ~2 ~-26 as @s[scores={eosand.pipe_num=2},distance=..0.25,x_rotation=-90..-45] run scoreboard players set @s eosand.junctions 2

# Center player in pipe immediately after junction to tp them cleanly
execute as @s[scores={eosand.junctions=2}] on vehicle run tp @s ~-26 ~5 ~-26
...
# Red
execute positioned ~-26 ~26 ~-26 as @s[scores={eosand.pipe_num=3},distance=..0.25,y_rotation=45..135,x_rotation=-45..45] run scoreboard players set @s eosand.pipe_num -1

# Yellow
execute positioned ~-26 ~26 ~-26 as @s[scores={eosand.pipe_num=3},distance=..0.25,y_rotation=135..180,x_rotation=-45..45] run scoreboard players set @s eosand.pipe_num -2
execute positioned ~-26 ~26 ~-26 as @s[scores={eosand.pipe_num=3},distance=..0.25,y_rotation=-180..-135,x_rotation=-45..45] run scoreboard players set @s eosand.pipe_num -2

# Green
execute positioned ~-26 ~26 ~-26 as @s[scores={eosand.pipe_num=3},distance=..0.25,y_rotation=-135..-45,x_rotation=-45..45] run scoreboard players set @s eosand.pipe_num -3

# Pink (correct)
execute positioned ~-26 ~26 ~-26 as @s[scores={eosand.pipe_num=3},distance=..0.25,y_rotation=-45..0,x_rotation=-45..45] run scoreboard players set @s eosand.junctions 3
execute positioned ~-26 ~26 ~-26 as @s[scores={eosand.pipe_num=3},distance=..0.25,y_rotation=0..45,x_rotation=-45..45] run scoreboard players set @s eosand.junctions 3
...
# Center player in pipe immediately after junction to tp them cleanly
execute as @s[scores={eosand.junctions=3}] on vehicle run tp @s ~-26 ~25 ~-24
...
# Red
execute positioned ~-26 ~26 ~ as @s[scores={eosand.pipe_num=4},distance=..0.25,y_rotation=45..135,x_rotation=-45..45] run scoreboard players set @s eosand.pipe_num -1
...
# Green (correct)
execute positioned ~-26 ~26 ~ as @s[scores={eosand.pipe_num=4},distance=..0.25,y_rotation=-135..-45,x_rotation=-45..45] run scoreboard players set @s eosand.junctions 4

# Pink
# execute positioned ~-26 ~26 ~-26 as @s[scores={eosand.pipe_num=3},distance=..0.25,y_rotation=-45..0,x_rotation=-45..45] run scoreboard players set @s eosand.pipe_num 4
# execute positioned ~-26 ~26 ~-26 as @s[scores={eosand.pipe_num=3},distance=..0.25,y_rotation=0..45,x_rotation=-45..45] run scoreboard players set @s eosand.pipe_num 4

# Cyan
execute positioned ~-26 ~26 ~-26 as @a[scores={eosand.pipe_num=4},distance=..0.25,x_rotation=45..90] run scoreboard players set @s eosand.pipe_num -5

# Purple
execute positioned ~-26 ~26 ~-26 as @a[scores={eosand.pipe_num=4},distance=..0.25,x_rotation=-90..-45] run scoreboard players set @s eosand.pipe_num -6

# Center player in pipe immediately after junction to tp them cleanly
execute as @s[scores={eosand.junctions=4}] on vehicle run tp @s ~-24 ~25 ~
...
execute positioned ~-4 ~26 ~ as @s[scores={eosand.pipe_num=5},distance=..0.25] run scoreboard players set @s eosand.pipes 2
execute positioned ~-4 ~26 ~ as @s[scores={eosand.pipe_num=5},distance=..0.25] at @s run playsound entity.player.levelup player @s
execute positioned ~-4 ~26 ~ as @s[scores={eosand.pipe_num=5},distance=..0.25] run scoreboard players set @s eosand.timer 0
execute positioned ~-4 ~26 ~ as @s[scores={eosand.pipe_num=5},distance=..0.25] run function eosand:colors/none

# Kill armor stand
execute positioned ~-4 ~26 ~ as @s[scores={eosand.pipe_num=5},distance=..0.25] on vehicle run kill @s

execute positioned ~-4 ~26 ~ as @s[scores={eosand.pipe_num=5},distance=..0.25] run scoreboard players set @s eosand.pipe_num 0
