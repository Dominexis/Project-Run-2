...
execute if entity @s[scores={eosand.timer=1}] run tellraw @s ["",{"text":"────────────────────────\n","color":"gray","type":"text"},{"text":" PIPELINE SECTION 4 - ","color":"gray","type":"text"},{"selector":"@s","color":"green","type":"selector"},{"text":" \n────────────────────────","color":"gray","type":"text"}]
...
# Open door
execute if entity @s[scores={eosand.timer=46}] run fill ~-1 ~ ~-2 ~1 ~2 ~-2 minecraft:air
