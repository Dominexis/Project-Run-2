...
# Open door
execute if entity @s[scores={eosand.timer=46}] run fill ~-1 ~2 ~-2 ~1 ~ ~-2 minecraft:air
execute if entity @s[scores={eosand.timer=46}] run particle minecraft:poof ~0.5 ~1.5 ~-1.5 1 1 0 0.01 10
