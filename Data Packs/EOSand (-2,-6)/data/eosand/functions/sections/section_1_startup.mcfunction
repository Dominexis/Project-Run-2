...
execute as @s[scores={eosand.timer=1}] run tellraw @s ["",{"text":"────────────────────────\n","color":"gray"},{"text":" PIPELINE SECTION 1 - ","color":"gray"},{"selector":"@s","color":"green"},{"text":" \n────────────────────────","color":"gray"}]
...
# Open door
execute if entity @s[scores={eosand.timer=46}] run fill ~-1 ~2 ~-2 ~1 ~ ~-2 air
execute if entity @s[scores={eosand.timer=46}] run particle poof ~0.5 ~1.5 ~-1.5 1 1 0 0.01 10
