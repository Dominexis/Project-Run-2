...
scoreboard players add #output pr.value 10000
...
execute at @s run summon minecraft:bat ~ ~ ~ {Tags:["pr.launch.pre"],DeathLootTable:"",NoAI:1b,Silent:1b,Health:1.0f,PersistenceRequired:1b}
