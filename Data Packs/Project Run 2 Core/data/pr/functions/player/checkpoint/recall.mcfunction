...
execute if score @s pr.plot_x matches 2 if score @s pr.plot_z matches -6 run function jpmagic:recall
...
execute if score @s pr.plot_x matches 2 if score @s pr.plot_z matches -5 run function decimate:recall
execute if score @s pr.plot_x matches 3 if score @s pr.plot_z matches -5 run function shadoweeq:recall
execute if score @s pr.plot_x matches -3 if score @s pr.plot_z matches -4 run function snowvillage:recall
execute if score @s pr.plot_x matches -2 if score @s pr.plot_z matches -4 run function billyandaspookabie:recall
execute if score @s pr.plot_x matches -1 if score @s pr.plot_z matches -4 run function kirnt:recall
execute if score @s pr.plot_x matches 0 if score @s pr.plot_z matches -4 run function sparkour:recall
execute if score @s pr.plot_x matches 1 if score @s pr.plot_z matches -4 run function klue007:recall
execute if score @s pr.plot_x matches 2 if score @s pr.plot_z matches -4 run function spooky:recall
execute if score @s pr.plot_x matches 3 if score @s pr.plot_z matches -4 run function kevinc:recall
...
execute if score @s pr.plot_x matches -3 if score @s pr.plot_z matches -2 run function reuge:recall
...
execute if score @s pr.plot_x matches 3 if score @s pr.plot_z matches -2 run function mooney:recall
execute if score @s pr.plot_x matches 4 if score @s pr.plot_z matches -2 run function ykw:recall
execute if score @s pr.plot_x matches 5 if score @s pr.plot_z matches -2 run function polds:recall
...
execute if score @s pr.plot_x matches 3 if score @s pr.plot_z matches -1 run function dominexis:recall
...
execute if score @s pr.plot_x matches -1 if score @s pr.plot_z matches 0 run function lobby:recall
execute if score @s pr.plot_x matches 0 if score @s pr.plot_z matches 0 run function cubed:recall
execute if score @s pr.plot_x matches 3 if score @s pr.plot_z matches 0 run function duality:recall
...
execute if score @s pr.plot_x matches -4 if score @s pr.plot_z matches 1 run function lazybrush:recall
...
execute if score @s pr.plot_x matches 4 if score @s pr.plot_z matches 1 run function piemel:recall
...
execute if score @s pr.plot_x matches 4 if score @s pr.plot_z matches 2 run function hhyes:recall
execute if score @s pr.plot_x matches 5 if score @s pr.plot_z matches 2 run function flcme:recall
execute if score @s pr.plot_x matches 6 if score @s pr.plot_z matches 2 run function titruc.interactivejump.sys:recall
execute if score @s pr.plot_x matches -5 if score @s pr.plot_z matches 3 run function earthmere:recall
...
execute if score @s pr.plot_x matches 0 if score @s pr.plot_z matches 4 run function lucumaprpack:recall
...
execute if score @s pr.plot_x matches 2 if score @s pr.plot_z matches 5 run function kello:recall
