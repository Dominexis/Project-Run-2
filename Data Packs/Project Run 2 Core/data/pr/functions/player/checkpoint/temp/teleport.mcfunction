...
execute store result storage pr:data tag.Pos[1] double 1 run scoreboard players get #y pr.value
...
execute at @s positioned ~0.5 ~ ~0.5 run teleport @a[tag=pr.player.target] ~ ~ ~ ~ ~
