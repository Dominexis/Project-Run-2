...
#execute unless score #plot_player_4_-3 pr.value = #plot_tick_4_-3 pr.value positioned 376.0 -64 -296.0 run tag @a[dx=95,dy=383,dz=95,tag=!pr.spectator] add pr.target
#execute unless score #plot_player_4_-3 pr.value = #plot_tick_4_-3 pr.value positioned 376.0 -64 -296.0 run tag @e[dx=95,dy=383,dz=95,tag=!pr.spectator,tag=!pr.ignore] add pr.target
...
#execute unless score #plot_player_4_-3 pr.value = #plot_tick_4_-3 pr.value run tag @a[tag=pr.target] remove pr.target
...
#execute if score #plot_tick_4_-3 pr.value matches 1 positioned 380.0 -64 -292.0 run tag @a[dx=87,dy=383,dz=87,tag=!pr.spectator] add pr.target
#execute if score #plot_tick_4_-3 pr.value matches 1 positioned 380.0 -64 -292.0 run tag @e[dx=87,dy=383,dz=87,tag=!pr.spectator,tag=!pr.ignore] add pr.target
...
#execute if score #plot_tick_4_-3 pr.value matches 1 run tag @a[tag=pr.target] remove pr.target
