...
#execute unless score #plot_player_0_4 pr.value = #plot_tick_0_4 pr.value positioned -8.0 -64 376.0 run tag @a[dx=95,dy=383,dz=95,tag=!pr.spectator] add pr.target
#execute unless score #plot_player_0_4 pr.value = #plot_tick_0_4 pr.value positioned -8.0 -64 376.0 run tag @e[dx=95,dy=383,dz=95,tag=!pr.spectator,tag=!pr.ignore] add pr.target
...
#execute unless score #plot_player_0_4 pr.value = #plot_tick_0_4 pr.value run tag @a[tag=pr.target] remove pr.target
...
#execute if score #plot_tick_0_4 pr.value matches 1 positioned -4.0 -64 380.0 run tag @a[dx=87,dy=383,dz=87,tag=!pr.spectator] add pr.target
#execute if score #plot_tick_0_4 pr.value matches 1 positioned -4.0 -64 380.0 run tag @e[dx=87,dy=383,dz=87,tag=!pr.spectator,tag=!pr.ignore] add pr.target
...
#execute if score #plot_tick_0_4 pr.value matches 1 run tag @a[tag=pr.target] remove pr.target
