...
execute if score @s pr.plot_x matches -3 if score @s pr.plot_z matches -5 run function ischool04_plot:exit
execute if score @s pr.plot_x matches -2 if score @s pr.plot_z matches -5 run function ronanemperor:exit
execute if score @s pr.plot_x matches -1 if score @s pr.plot_z matches -5 run function spinat:exit
...
execute if score @s pr.plot_x matches 1 if score @s pr.plot_z matches -4 run function klue007:exit
execute if score @s pr.plot_x matches 2 if score @s pr.plot_z matches -4 run function spooky:exit
execute if score @s pr.plot_x matches 3 if score @s pr.plot_z matches -4 run function kevinc:exit
execute if score @s pr.plot_x matches -5 if score @s pr.plot_z matches -3 run function bowshot:exit
execute if score @s pr.plot_x matches -4 if score @s pr.plot_z matches -3 run function xekyt:exit
...
execute if score @s pr.plot_x matches -4 if score @s pr.plot_z matches -2 run function fuzzbearplush:exit
...
execute if score @s pr.plot_x matches 5 if score @s pr.plot_z matches -2 run function poldslippers:exit
...
execute if score @s pr.plot_x matches 4 if score @s pr.plot_z matches 1 run function piemel:exit
...
execute if score @s pr.plot_x matches 1 if score @s pr.plot_z matches 2 run function minerman:exit
execute if score @s pr.plot_x matches 3 if score @s pr.plot_z matches 2 run function im1294:exit
execute if score @s pr.plot_x matches 4 if score @s pr.plot_z matches 2 run function hhyes:exit
execute if score @s pr.plot_x matches 5 if score @s pr.plot_z matches 2 run function flcme:exit
execute if score @s pr.plot_x matches 6 if score @s pr.plot_z matches 2 run function titruc.interactivejump.sys:exit
execute if score @s pr.plot_x matches -5 if score @s pr.plot_z matches 3 run function earthmere:exit
execute if score @s pr.plot_x matches -4 if score @s pr.plot_z matches 3 run function fabulousfox:exit
execute if score @s pr.plot_x matches -2 if score @s pr.plot_z matches 3 run function stabily_time_tower_parkour:exit
execute if score @s pr.plot_x matches -1 if score @s pr.plot_z matches 3 run function woutbelt:exit
...
execute if score @s pr.plot_x matches 5 if score @s pr.plot_z matches 3 run function wall_hall:exit
execute if score @s pr.plot_x matches -3 if score @s pr.plot_z matches 4 run function zombie1111:exit
execute if score @s pr.plot_x matches -2 if score @s pr.plot_z matches 4 run function platform:exit
...
execute if score @s pr.plot_x matches 2 if score @s pr.plot_z matches 4 run function cobra2:exit
...
execute unless score @s spectate matches 1.. if score @s pr.plot_x matches -1 if score @s pr.plot_z matches 0 run tellraw @s {"text":"Your run has begun","color":"gold"}
execute unless score @s spectate matches 1.. if score @s pr.plot_x matches -1 if score @s pr.plot_z matches 0 run tellraw @s [{"text":"Use ","color":"gray"},{"text":"/trigger lobby","color":"white"},{"text":" to return to the lobby","color":"gray"}]
execute unless score @s spectate matches 1.. if score @s pr.plot_x matches -1 if score @s pr.plot_z matches 0 run tellraw @s [{"text":"Use ","color":"gray"},{"text":"/trigger checkpoint","color":"white"},{"text":" to go to the previous checkpoint","color":"gray"}]
