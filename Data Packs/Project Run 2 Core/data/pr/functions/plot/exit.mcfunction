...
execute if score @s pr.plot_x matches 2 if score @s pr.plot_z matches -6 run function jpmagic:exit
...
execute if score @s pr.plot_x matches -2 if score @s pr.plot_z matches -4 run function billyandaspookabie:exit
...
execute if score @s pr.plot_x matches 4 if score @s pr.plot_z matches 3 run function big_kitchen:exit
...
execute if score @s pr.plot_x matches 0 if score @s pr.plot_z matches 4 run function lucumaprpack:exit
...
execute if score @s pr.plot_x matches 2 if score @s pr.plot_z matches 5 run function kello:exit
