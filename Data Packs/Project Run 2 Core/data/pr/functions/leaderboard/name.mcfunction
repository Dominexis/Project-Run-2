...
# -1, -5
execute if score #plot pr.value matches 719 run data modify storage pr:data tag.leaderboard_name set value '{"text":"-1, -5 Ending"}'
# 1, -5
...
# -5, -3
execute if score #plot pr.value matches 843 run data modify storage pr:data tag.leaderboard_name set value '{"text":"-5, -3 Ending"}'
# 5, -3
execute if score #plot pr.value matches 853 run data modify storage pr:data tag.leaderboard_name set value '{"text":"5, -3 Ending"}'
# -6, -2
...
# 6, -2
execute if score #plot pr.value matches 918 run data modify storage pr:data tag.leaderboard_name set value '{"text":"6, -2 Ending"}'
# -5, -1
...
# 5, -1
execute if score #plot pr.value matches 981 run data modify storage pr:data tag.leaderboard_name set value '{"text":"5, -1 Ending"}'
# -1, 0
...
# -6, 2
execute if score #plot pr.value matches 1162 run data modify storage pr:data tag.leaderboard_name set value '{"text":"-6, 2 Ending"}'
# 6, 2
...
# 5, 3
execute if score #plot pr.value matches 1237 run data modify storage pr:data tag.leaderboard_name set value '{"text":"5, 3 Ending"}'
# -3, 5
execute if score #plot pr.value matches 1357 run data modify storage pr:data tag.leaderboard_name set value '{"text":"-3, 5 Ending"}'
# -1, 5
...
# 3, 5
execute if score #plot pr.value matches 1363 run data modify storage pr:data tag.leaderboard_name set value '{"text":"3, 5 Ending"}'
# -2, 6
