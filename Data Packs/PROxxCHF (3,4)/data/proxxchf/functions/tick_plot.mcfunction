...
# Cherry button (2nd)
execute positioned ~26 ~37 ~31 if block ~ ~ ~ minecraft:cherry_button[face=floor,powered=true] run tellraw @p[tag=pr.target] ["",{"text":"[Parkour]","color":"red","type":"text"},{"text":" Try to see behind you!","color":"white","type":"text"}]
execute if block ~26 ~37 ~31 minecraft:cherry_button[face=floor,powered=true] run clone ~13 ~72 ~17 ~10 ~67 ~-7 ~10 ~34 ~-7
execute if block ~26 ~37 ~31 minecraft:cherry_button[face=floor,powered=true] run particle minecraft:cloud ~12 ~36 ~5 2 1.5 6 0.001 100 force
...
execute positioned ~16 ~26 ~-11 as @a[distance=..2,tag=pr.target] run setblock ~ ~ ~ minecraft:air
...
# Removes the parkor
execute positioned ~16 ~55 ~-11 as @a[distance=..2,tag=pr.target] positioned ~-6 ~-21 ~4 unless entity @a[dx=3,dy=5,dz=24,tag=pr.target] run fill ~ ~ ~ ~3 ~5 ~24 minecraft:air

# End
execute positioned ~16 ~60 ~-11 as @a[distance=..2,tag=pr.target] positioned ~-16 ~-60 ~11 run function proxxchf:end

# Particles
execute positioned ~16 ~46 ~-11 as @a[distance=..2,tag=pr.target] positioned ~-16 ~-46 ~11 run fill ~15 ~55 ~-12 ~17 ~64 ~-10 minecraft:air
execute positioned ~16 ~46 ~-11 as @a[distance=..2,tag=pr.target] positioned ~-16 ~-46 ~11 run setblock ~13 ~65 ~-24 minecraft:redstone_block
execute if block ~13 ~65 ~-24 minecraft:redstone_block run particle minecraft:reverse_portal ~16 ~56 ~-11 0.75 4 0.75 0.001 10 force

# DIE
execute as @a[tag=pr.target] at @s if block ~ ~-0.2 ~ minecraft:gray_concrete_powder run kill @s
return 1