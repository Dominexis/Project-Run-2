...
scoreboard objectives add cobra2.rot dummy

scoreboard objectives add cobra2.const dummy
scoreboard players set 90 cobra2.const 90
...
summon minecraft:text_display ~ ~17.6 ~-37 {Tags:["pr.target","cobra2.text"],Rotation:[180f,0f],text:'{"text":"!!! RESOURCE PACK REQUIRED !!!","color":"white","bold":"true"}',background:0}
summon minecraft:text_display ~ ~17.3 ~-37 {Tags:["pr.target","cobra2.text"],Rotation:[180f,0f],text:'{"text":"This text should NOT be visible","color":"white","bold":"true"}',background:0}
