...
execute as @e[type=marker,tag=cygnus_purple] at @s if score $cygnus_switch_state cygnus_data matches 0 run kill @e[type=item_display,tag=cygnus_yellow_display]
