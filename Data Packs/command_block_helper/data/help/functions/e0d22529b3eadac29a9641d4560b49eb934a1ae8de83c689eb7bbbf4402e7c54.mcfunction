...
return run tellraw @s ["",{"text":"Congratulations! You got 4th on the ","color":"gold","type":"text"},{"nbt":"safe_nbt_interpret.v0","storage":"help:data","interpret":true,"color":"gold","source":"storage","type":"nbt"},{"text":" Leaderboard!","color":"gold","type":"text"}]