...
return run title @s[tag=Green] actionbar [{"text":"You are ","color":"gold","type":"text"},{"text":"GREEN      ","color":"green","bold":true,"type":"text"},{"nbt":"safe_nbt_interpret.v0","storage":"help:data","interpret":true,"source":"storage","type":"nbt"},{"text":":","color":"gray","type":"text"},{"nbt":"safe_nbt_interpret.v1","storage":"help:data","interpret":true,"source":"storage","type":"nbt"},{"text":".","color":"gray","type":"text"},{"nbt":"safe_nbt_interpret.v2","storage":"help:data","interpret":true,"source":"storage","type":"nbt"}]