...
return run title @s[tag=pr.hide_timer] actionbar [{"text":"Cooldown: ","color":"dark_aqua","type":"text"},{"score":{"name":"@s","objective":"ykw.cooldown_s"},"type":"score"},{"text":"s  Timer: ","type":"text"},{"nbt":"safe_nbt_interpret.v0","storage":"help:data","interpret":true,"source":"storage","type":"nbt"},":",{"nbt":"safe_nbt_interpret.v1","storage":"help:data","interpret":true,"source":"storage","type":"nbt"},".",{"nbt":"safe_nbt_interpret.v2","storage":"help:data","interpret":true,"source":"storage","type":"nbt"}]