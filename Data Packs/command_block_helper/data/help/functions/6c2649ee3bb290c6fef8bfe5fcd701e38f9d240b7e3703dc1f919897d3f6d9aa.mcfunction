...
return run title @s[scores={dtplayers.oxygen=0..14,dtplayers.oxygen_lose=0..3}] actionbar [{"nbt":"safe_nbt_interpret.v0","storage":"help:data","interpret":true,"source":"storage","type":"nbt"},{"text":":","color":"gray","type":"text"},{"nbt":"safe_nbt_interpret.v1","storage":"help:data","interpret":true,"source":"storage","type":"nbt"},{"text":".","color":"gray","type":"text"},{"nbt":"safe_nbt_interpret.v2","storage":"help:data","interpret":true,"source":"storage","type":"nbt"},{"text":"  ●  ","color":"gray","type":"text"},{"score":{"name":"@s","objective":"dtplayers.oxygen"},"color":"red","bold":true,"type":"score"},{"text":" O₂ ⚠","color":"red","bold":false,"type":"text"}]