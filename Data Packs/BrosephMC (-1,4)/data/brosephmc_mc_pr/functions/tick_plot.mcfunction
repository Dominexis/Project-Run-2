...
execute as @a[tag=pr.target, scores={brosephmc_mc_pr_tpTimer=1..}] at @s run playsound minecraft:entity.parrot.eat player @a ~ ~ ~ 0.3 0.5
execute as @a[tag=pr.target, scores={brosephmc_mc_pr_tpTimer=60..}] run playsound minecraft:entity.player.levelup player @a ~25 ~18 ~-27
execute as @a[tag=pr.target, scores={brosephmc_mc_pr_tpTimer=60..}] run tp @s ~25 ~18 ~-27 0 15
execute as @a[tag=pr.target, scores={brosephmc_mc_pr_tpTimer=60..}] run playsound minecraft:entity.enderman.teleport player @a ~25 ~18 ~-27
...
#sound fx
execute at @a[tag=pr.target,scores={fall=1..}] unless block ~ ~-2 ~ deepslate run playsound minecraft:entity.iron_golem.hurt player @a ~ ~ ~ 0.5 2
...
#falling on the road
execute as @a[tag=pr.target,gamemode=!spectator,gamemode=!creative] at @s if block ~ ~-1.1 ~ deepslate run playsound minecraft:entity.player.attack.knockback player @a ~ ~ ~ 100
execute as @a[tag=pr.target,gamemode=!spectator,gamemode=!creative] at @s if block ~ ~-1.1 ~ deepslate run playsound minecraft:entity.player.death player @a ~ ~ ~ 5
...
execute as @a[tag=pr.target] positioned ~25 ~19 ~30 if entity @s[distance=..1] align xyz run playsound minecraft:entity.enderman.teleport player @a ~-24.5 ~0 ~-0.5 5
...
execute as @e[tag=pr.target,tag=tunnelBat] at @s if block ~ ~ ~-0.3 #brosephmc_mc_pr:no_collision positioned ^ ^ ^4 unless entity @p[distance=..4] positioned ^ ^ ^-4 run tp @s ~ ~ ~-0.3 180 0
execute as @e[tag=pr.target,tag=tunnelBat] at @s unless block ~ ~ ~-0.3 #brosephmc_mc_pr:no_collision run tp @s ~ ~0.3 ~0.3 180 0
execute as @e[tag=pr.target,tag=tunnelBat] at @s positioned ^ ^ ^4 if entity @p[distance=..4] positioned ^ ^ ^-4 facing entity @p feet run tp @s ^ ^ ^0.3 facing entity @p feet
execute as @e[tag=pr.target,tag=tunnelBat,tag=!playedSound] at @s positioned ^ ^ ^4 if entity @p[distance=..4] positioned ^ ^ ^-4 facing entity @p feet run playsound minecraft:entity.bat.takeoff neutral @a
execute as @e[tag=pr.target,tag=tunnelBat,tag=!playedSound] at @s positioned ^ ^ ^4 if entity @p[distance=..4] positioned ^ ^ ^-4 facing entity @p feet run team join brosephmc_mc_pr_angryBat @s
execute as @e[tag=pr.target,tag=tunnelBat,tag=!playedSound] at @s positioned ^ ^ ^4 if entity @p[distance=..4] positioned ^ ^ ^-4 facing entity @p feet run tag @s add playedSound
execute at @a[tag=pr.target] run effect give @e[tag=tunnelBat,distance=..9] glowing 1 0 true
...
execute as @e[tag=pr.target,tag=batZombie] at @s unless entity @e[tag=tunnelBat,distance=..1] run kill @s