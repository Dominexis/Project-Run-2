...
execute at @e[tag=FW1,tag=pr.target] run summon firework_rocket ~ ~ ~ {LifeTime:30,FireworksItem:{id:firework_rocket,Count:1,tag:{Fireworks:{Explosions:[{Type:1,Colors:[I;2651799,6719955],FadeColors:[I;14602026]}],Flight:1}}}}
execute at @e[tag=FW2,tag=pr.target] run summon firework_rocket ~ ~ ~ {LifeTime:20,FireworksItem:{id:firework_rocket,Count:1,tag:{Fireworks:{Explosions:[{Type:0,Colors:[I;2651799,6719955],FadeColors:[I;14602026]}],Flight:1}}}}
execute at @e[tag=FW3,tag=pr.target] run summon firework_rocket ~ ~ ~ {LifeTime:32,FireworksItem:{id:firework_rocket,Count:1,tag:{Fireworks:{Explosions:[{Type:1,Colors:[I;2651799,6719955],FadeColors:[I;14602026]}],Flight:1}}}}
execute at @e[tag=FW4,tag=pr.target] run summon firework_rocket ~ ~ ~ {LifeTime:18,FireworksItem:{id:firework_rocket,Count:1,tag:{Fireworks:{Explosions:[{Type:0,Colors:[I;2651799,6719955],FadeColors:[I;14602026]}],Flight:1}}}}
