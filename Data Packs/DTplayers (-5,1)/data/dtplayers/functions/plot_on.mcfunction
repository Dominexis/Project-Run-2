...
#rl 1
summon block_display ~5.4375 ~20.875 ~4.5 {Rotation:[0F,0F],width:2f,height:3f,Tags:["dtplayers.prop"],brightness:{sky:10,block:15},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1.125f,2.25f,1f]},block_state:{Name:"minecraft:light_blue_stained_glass_pane",Properties:{east:"true",west:"true"}}}

#rl 2
summon block_display ~1.4375 ~45.875 ~-12.5 {Rotation:[90F,0F],width:2f,height:3f,Tags:["dtplayers.prop"],brightness:{sky:10,block:15},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1.125f,2.25f,1f]},block_state:{Name:"minecraft:light_blue_stained_glass_pane",Properties:{east:"true",west:"true"}}}

#rl 3
summon block_display ~6.4375 ~59.875 ~-7.5 {Rotation:[90F,0F],width:2f,height:3f,Tags:["dtplayers.prop"],brightness:{sky:10,block:15},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1.125f,2.25f,1f]},block_state:{Name:"minecraft:light_blue_stained_glass_pane",Properties:{east:"true",west:"true"}}}
