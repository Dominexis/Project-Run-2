...
execute as @a[tag=pr.target] store result score @s itspungpond98.item run clear @s minecraft:verdant_froglight 0
clear @a[tag=pr.target,scores={itspungpond98.item=2..}] minecraft:verdant_froglight 1
...
execute as @a[tag=pr.target] store result score @s itspungpond98.item run clear @s minecraft:pearlescent_froglight 0
clear @a[tag=pr.target,scores={itspungpond98.item=2..}] minecraft:pearlescent_froglight 1
...
execute as @e[type=minecraft:item,tag=pr.target,tag=!itspungpond98.processed] run function itspungpond98:process_item
