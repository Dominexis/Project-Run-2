...
execute positioned ~37 ~17 ~-2 as @a[dx=-4,dy=2,dz=5,tag=pr.target,scores={itspungpond98.villager=1..},tag=itspungpond98.haveverdant] if score verdant itspungpond98.exit matches ..0 run clear @s verdant_froglight
execute positioned ~37 ~17 ~-2 as @a[dx=-4,dy=2,dz=5,tag=pr.target,scores={itspungpond98.villager=1..},tag=itspungpond98.haveverdant] if score verdant itspungpond98.exit matches ..0 run scoreboard players set verdant itspungpond98.exit 1
...
execute positioned ~37 ~17 ~-2 as @a[dx=-4,dy=2,dz=5,tag=pr.target,scores={itspungpond98.villager=1..},tag=itspungpond98.havepearlescent] run function itspungpond98:passitemerror/verdant