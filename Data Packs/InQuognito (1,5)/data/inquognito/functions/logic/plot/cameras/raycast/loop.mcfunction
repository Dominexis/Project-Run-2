...
execute positioned ~-0.5 ~-0.5 ~-0.5 if entity @p[predicate=inquognito:player,dx=0] facing entity @p[predicate=inquognito:player,dx=0] eyes if score @s inquognito.raycast_success matches 0 run function inquognito:logic/plot/cameras/raycast/success
