...
execute align xyz positioned ^ ^-1 ^ as @a[dy=2,tag=pr.target,scores={inquognito.floor=0,inquognito.clearance.frostbite=..2}] positioned ^0.5 ^ ^ run function inquognito:logic/plot/gates/block
