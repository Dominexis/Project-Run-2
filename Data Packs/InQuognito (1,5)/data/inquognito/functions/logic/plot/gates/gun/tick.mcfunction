...
execute align xyz positioned ^ ^-3 ^ as @a[tag=pr.target,scores={inquognito.floor=0,inquognito.clearance=0},dy=6] positioned ~0.5 ~ ~ run function inquognito:logic/plot/gates/block
