...
execute align xyz positioned ^ ^-1 ^ as @e[predicate=inquognito:targets,scores={inquognito.clearance.bounce_pad_room=..3},dy=2] positioned ^0.5 ^ ^ run function inquognito:logic/plot/gates/block
