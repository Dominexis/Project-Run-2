...
execute align xyz positioned ^ ^-1 ^ as @a[tag=pr.target,scores={inquognito.floor=0},predicate=inquognito:energy_clearance,dy=2] positioned ^0.5 ^ ^ run function inquognito:logic/plot/gates/block
