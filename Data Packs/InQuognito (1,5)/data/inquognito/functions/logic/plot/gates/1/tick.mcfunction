...
execute align xyz positioned ^ ^-1 ^ as @a[tag=pr.target,scores={inquognito.floor=0,inquognito.clearance=..1},dy=2] positioned ^0.5 ^ ^ run function inquognito:logic/plot/gates/block
