...
execute if score #modulo inquognito.temp matches 0 as @a[tag=pr.target,scores={inquognito.floor=-1},tag=!inquognito.clearance.nova] run function inquognito:logic/plot/gates/4/particles
