...
execute if score #modulo inquognito.temp matches 0 as @a[tag=pr.target,tag=!inquognito.clearance.nova,scores={inquognito.floor=-1}] run function inquognito:logic/plot/gates/4/particles
