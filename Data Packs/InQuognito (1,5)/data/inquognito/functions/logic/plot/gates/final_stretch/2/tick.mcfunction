...
execute if score #modulo inquognito.temp matches 0 as @a[tag=pr.target,scores={inquognito.floor=-1},tag=!inquognito.clearance.boss] run function inquognito:logic/plot/gates/final_stretch/2/particles
