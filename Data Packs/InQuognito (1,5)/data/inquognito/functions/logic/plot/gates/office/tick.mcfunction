...
execute align xyz positioned ^ ^-1 ^ as @a[tag=pr.target,scores={inquognito.floor=0,inquognito.clearance.office=..2},dy=2] positioned ^0.5 ^ ^ run function inquognito:logic/plot/gates/block
