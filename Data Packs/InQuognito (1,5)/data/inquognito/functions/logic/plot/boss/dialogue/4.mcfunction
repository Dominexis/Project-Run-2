...
tellraw @s[scores={inquognito.dialogue.tick=420}] [{"text":"Scientist | ","color":"yellow"},{"text":"The explosions... caused a rupture in the wall.","color":"white"}]
...
tellraw @s[scores={inquognito.dialogue.tick=540}] [{"text":"Scientist | ","color":"yellow"},{"text":"It is... too powerful to stop.","color":"white"}]
...
execute if score @s inquognito.dialogue.tick matches 600.. run function inquognito:logic/plot/boss/defeat
