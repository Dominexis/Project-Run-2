...
tellraw @s[scores={inquognito.transmission.tick=1}] [{"text":"Simaris | ","color":"aqua","type":"text"},{"text":"Hunter, the switches you activated appears to have opened the barrier in this room.","color":"white","type":"text"}]
