...
execute if score #modulo inquognito.temp matches 0 as @a[tag=pr.target,scores={inquognito.floor=0},tag=!inquognito.gun.trinity] run function inquognito:logic/gates/2/particles
