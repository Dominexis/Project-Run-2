...
# start & end games
execute positioned ~11 ~24 ~0 as @a[tag=technodono_plot.is_in_plot,tag=!technodono_plot.ready,distance=..1,tag=pr.target] run function technodono_plot_-2_-3:start
execute positioned ~20 ~-49 ~14 as @a[tag=technodono_plot.is_in_plot,tag=!technodono_plot.ready,distance=..1,tag=pr.target] run function technodono_plot_-2_-3:end
