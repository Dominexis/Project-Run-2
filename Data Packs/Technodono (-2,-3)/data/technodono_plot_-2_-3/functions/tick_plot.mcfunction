...
execute as @a[tag=technodono_plot.playing] if score @s technodono_plot.r-click_counter matches 0 run item replace entity @s weapon.offhand with minecraft:carrot_on_a_stick
